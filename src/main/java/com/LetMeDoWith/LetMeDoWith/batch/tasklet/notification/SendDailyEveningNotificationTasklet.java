...
public class SendDailyEveningNotificationTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        if (!sendNotificationResult.failedMemberIds().isEmpty()) {
            log.error(
                    "데일리 저녁 알림 발송 실패 - templateCode: {}, failedMemberIds: {}",
                    templateCode,
    ...
    NotificationTemplateCode resolveTemplateCode(DayOfWeek dayOfWeek) {
        return switch (dayOfWeek) {
            case MONDAY -> NotificationTemplateCode.DAILY_MON_PM;
            case TUESDAY -> NotificationTemplateCode.DAILY_TUES_PM;
            case WEDNESDAY -> NotificationTemplateCode.DAILY_WED_PM;
            case THURSDAY -> NotificationTemplateCode.DAILY_THURS_PM;
            case FRIDAY -> NotificationTemplateCode.DAILY_FRI_PM;
            case SATURDAY -> NotificationTemplateCode.DAILY_SAT_PM;
            case SUNDAY -> NotificationTemplateCode.DAILY_SUN_PM;
        };
    }
}
