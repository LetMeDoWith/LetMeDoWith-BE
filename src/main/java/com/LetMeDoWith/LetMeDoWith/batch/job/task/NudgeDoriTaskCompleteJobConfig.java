...
import com.LetMeDoWith.LetMeDoWith.batch.tasklet.task.NudgeDoriTaskCompleteTasklet;
...
public class NudgeDoriTaskCompleteJobConfig {
    ...
    @Bean
    @JobScope
    public Step nudgeDoriTaskCompleteStep(NudgeDoriTaskCompleteTasklet nudgeDoriTaskCompleteTasklet) {
        return new StepBuilder("nudgeDoriTaskCompleteStep", jobRepository)
                .tasklet(nudgeDoriTaskCompleteTasklet, platformTransactionManager)
                .build();
    }
}
