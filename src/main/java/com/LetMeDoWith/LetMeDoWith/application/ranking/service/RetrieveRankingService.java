...
public class RetrieveRankingService {
    ...
    public RetrieveRankingsResult retrieveRankingsByTopicId(Long rankingTopicId, Integer year, Integer month, Integer week, Integer limit) {
        List<RankingsQueryDto> rankings = rankingQueryRepository.getRankingsByTopicId(rankingTopicId, year, month, week, limit);
        return RetrieveRankingsResult.from(rankings);
    }
    
    public RetrieveMyRankingResult retrieveMyRanking(String memberId, Long rankingTopicId, Integer year, Integer month, Integer week) {
