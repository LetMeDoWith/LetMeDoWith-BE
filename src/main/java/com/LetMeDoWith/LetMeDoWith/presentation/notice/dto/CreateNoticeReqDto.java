...
public record CreateNoticeReqDto(
        ...
        @Schema(description = "노출 시작 일시", example = "2026-01-01T00:00:00") LocalDateTime startDateTime,
        @Schema(description = "노출 종료 일시", example = "2026-01-08T00:00:00") LocalDateTime endDateTime,
