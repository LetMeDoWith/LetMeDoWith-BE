...
public record UpdateMemberTermAgreeReqDto(
        @Schema(description = "약관 동의 여부", example = "true") boolean isTermsAgree,
        @Schema(description = "개인정보 활용 동의 여부", example = "true") boolean isPrivacyAgree,
        @Schema(description = "광고성 메세지 수신 동의 여부", example = "false") boolean isAdvertisementAgree) {
