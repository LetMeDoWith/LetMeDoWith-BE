...
public class AuthController {
    ...
    public ResponseEntity<ResponseDto<CreateRefreshTokenResDto>> createTokenRefresh(
        ...
        CreateRefreshTokenResult result =
                createTokenService.createRefreshToken(accessToken, requestBody.refreshToken(), userAgent);
    ...
    public ResponseEntity<ResponseDto<CreateTokenResDto>> createToken(
        ...
        CreateTokenResult createTokenResultRequestResult =
                createTokenService.createToken(createTokenReqDto.provider(), createTokenReqDto.idToken());
