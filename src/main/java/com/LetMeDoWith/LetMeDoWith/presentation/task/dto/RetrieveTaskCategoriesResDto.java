...
public record RetrieveTaskCategoriesResDto(
    ...
    public static RetrieveTaskCategoriesResDto from(TaskCategory taskCategory) {
        return new RetrieveTaskCategoriesResDto(taskCategory.getId(),
    ...
    public static List<RetrieveTaskCategoriesResDto> from(List<TaskCategory> catList) {
        return catList.stream().map(RetrieveTaskCategoriesResDto::from).toList();
    }
