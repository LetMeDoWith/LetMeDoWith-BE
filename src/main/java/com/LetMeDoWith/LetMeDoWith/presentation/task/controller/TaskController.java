...
import com.LetMeDoWith.LetMeDoWith.presentation.task.dto.GetTasksResDto;
import com.LetMeDoWith.LetMeDoWith.presentation.task.enums.TaskType;
...
public class TaskController {
    ...
    @GetMapping("")
    public ResponseEntity<ResponseDto<GetTasksResDto>> getTasks(
        @RequestParam(value = "type", defaultValue = "ALL")
        TaskType type, @RequestParam(value = "startDate")
        LocalDate startDate, @RequestParam(value = "endDate") LocalDate endDate) {
