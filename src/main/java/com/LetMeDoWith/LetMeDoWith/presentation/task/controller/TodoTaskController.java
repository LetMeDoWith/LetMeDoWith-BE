...
public class TodoTaskController {
    ...
    @ApiSuccessResponse(
        description = "투두모드 태스크 완료 성공. 본 API는 완료된 태스크의 ID를 반환합니다.")
    @ApiErrorResponses({
        @ApiErrorResponse(status = FailResponseStatus.INVALID_REQUEST, description = "잘못된 요청입니다."),
    })
    ...
    @ApiSuccessResponse(
        description = "투두모드 태스크 완료 취소 성공. 본 API는 대기상태로 전환된 태스크의 ID를 반환합니다.")
    @ApiErrorResponses({
        @ApiErrorResponse(status = FailResponseStatus.INVALID_REQUEST, description = "잘못된 요청입니다."),
    })
    ...
    @ApiSuccessResponse(
        description = "투두모드 태스크(루틴포함) 삭제 성공.")
    @ApiErrorResponses({
        @ApiErrorResponse(status = FailResponseStatus.INVALID_REQUEST, description = "잘못된 요청입니다."),
    })
