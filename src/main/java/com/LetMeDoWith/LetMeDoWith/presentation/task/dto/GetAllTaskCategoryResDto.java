...
public record GetAllTaskCategoryResDto(
    Long id,
    String title,
    ...
    public static GetAllTaskCategoryResDto from(TaskCategory taskCategory) {
        return new GetAllTaskCategoryResDto(taskCategory.getId(),
    ...
    public static List<GetAllTaskCategoryResDto> from(List<TaskCategory> catList) {
        return catList.stream().map(GetAllTaskCategoryResDto::from).toList();
    }
