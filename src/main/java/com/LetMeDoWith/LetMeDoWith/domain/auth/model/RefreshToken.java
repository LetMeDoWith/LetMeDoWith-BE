...
public class RefreshToken {
    ...
    public static RefreshToken of(String memberId, String accessToken, String userAgent,
                                  Long expireSec) {
    ...
    public void checkTokenOwnership(String reqMemberId, String reqAccessToken,
                                    String reqUserAgent) {
