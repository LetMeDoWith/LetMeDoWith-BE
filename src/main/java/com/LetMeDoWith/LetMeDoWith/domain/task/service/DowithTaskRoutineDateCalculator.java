...
public class DowithTaskRoutineDateCalculator {
    ...
    public RoutineDateResult getRoutineDatesToModify(DowithTask dowithTask,
        ...
        return RoutineDateResult.of(
            toCreateRoutineDates,
            toDeleteRoutineDates);
    }
    ...
    public static class RoutineDateResult {
        ...
        public static RoutineDateResult of(
            Set<LocalDate> toCreateRoutineDates,
            Set<LocalDate> toDeleteRoutineDates
        ) {
            return new RoutineDateResult(true, toCreateRoutineDates,
                                         toDeleteRoutineDates);
        }
