...
@Component
public class FeedbackResendPolicy {

    private static final int FREE_THRESHOLD = 5;

    /**
     * 특정 두윗에 대해 발신자가 잔소리를 다시 보낼 수 있는지 판단한다.
     ...
     * @param now            현재 시각
     */
    public boolean canResend(long feedbackCount, Optional<DowithTaskFeedback> latestFeedback, LocalDateTime now) {
