...
public enum FailResponseStatus {
    ...
    LOGIN_ATTEMPTED_SUSPENED("LOGIN_ATTEMPTED_SUSPENED", "E216", HttpStatus.BAD_REQUEST, "이용이 정지된 회원입니다."),
    LOGIN_ATTEMPTED_WITHDRAWN("LOGIN_ATTEMPTED_WITHDRAWN", "E217", HttpStatus.BAD_REQUEST, "탈퇴한 회원입니다."),
    ...
    MEMBER_CANNOT_WITHDRAW(
            "MEMBER_CANNOT_WITHDRAW", "E220", HttpStatus.BAD_REQUEST, "회원을 찾을 수 없습니다. 이미 탈퇴하였거나 회원가입이 완료되지 않았습니다."),
    MEMBER_NOT_EXIST_BADGE("MEMBER_BADGE_NOT_EXIST", "E220", HttpStatus.BAD_REQUEST, "뱃지 관련 작업 수행을 위한 회원이 존재하지 않습니다."),
    BADGE_NOT_EXIST("BADGE_NOT_EXIST", "E221", HttpStatus.BAD_REQUEST, "해당 뱃지가 존재하지 않습니다"),
    LAZY_NOT_AVAIL_UPDATE_MAIN_BADGE(
            "LAZY_NOT_AVAIL_UPDATE_MAIN_BADGE", "E222", HttpStatus.BAD_REQUEST, "레이지 뱃지를 받은 회원은 대표 뱃지를 설정할 수 없습니다."),
    ...
    DOWITH_TASK_CREATE_COUNT_EXCEED(
            "DOWITH_TASK_CREATE_COUNT_EXCEED", "E230", HttpStatus.BAD_REQUEST, "등록 가능한 두윗모드 갯수를 초과하였습니다."),
