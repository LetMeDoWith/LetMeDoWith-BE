...
VALUES ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XA', NOW(), NOW(), 'admin', 'admin', '1810473492', 'NORMAL', 'GOOD', 'a1', 'a1 자기소개', 'USER',
        's3:://a1_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XB', NOW(), NOW(), 'admin', 'admin', '2810473493', 'NORMAL', 'BAD', 'a2', 'a2 자기소개', 'USER',
        's3:://a2_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XC', NOW(), NOW(), 'admin', 'admin', '3810473494', 'NORMAL', 'GOOD', 'a3', 'a3 자기소개', 'USER',
        's3:://a3_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XD', NOW(), NOW(), 'admin', 'admin', '4810473495', 'NORMAL', 'GOOD', 'a4', 'a4 자기소개', 'USER',
        's3:://a4_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XE', NOW(), NOW(), 'admin', 'admin', '5810473496', 'NORMAL', 'GOOD', 'a5', 'a5 자기소개', 'USER',
        's3:://a5_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XF', NOW(), NOW(), 'admin', 'admin', '6810473497', 'NORMAL', 'GOOD', 'a6', 'a6 자기소개', 'USER',
        's3:://a6_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XG', NOW(), NOW(), 'admin', 'admin', '7810473498', 'NORMAL', 'GOOD', 'a7', 'a7 자기소개', 'USER',
        's3:://a7_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XH', NOW(), NOW(), 'admin', 'admin', '8810473499', 'NORMAL', 'GOOD', 'a8', 'a8 자기소개', 'USER',
        's3:://a8_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XI', NOW(), NOW(), 'admin', 'admin', '9810473490', 'NORMAL', 'GOOD', 'a9', 'a9 자기소개', 'USER',
        's3:://a9_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XJ', NOW(), NOW(), 'admin', 'admin', '9110473491', 'NORMAL', 'GOOD', 'a10', 'a10 자기소개', 'USER',
        's3:://a10_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XK', NOW(), NOW(), 'admin', 'admin', '9210473492', 'NORMAL', 'GOOD', 'a11', 'a11 자기소개', 'USER',
        's3:://a11_profile_image'),
       ('01HXQ2X7Z7Q6XJX4X2X7Z7Q6XL', NOW(), NOW(), 'admin', 'admin', '9310473493', 'NORMAL', 'GOOD', 'a12', 'a12 자기소개', 'USER',
