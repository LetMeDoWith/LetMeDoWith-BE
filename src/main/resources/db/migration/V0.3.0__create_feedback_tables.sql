...
-- 1. task_feedback_emoji 테이블
CREATE TABLE task_feedback_emoji
(
    ...
    CONSTRAINT pk_task_feedback_emoji PRIMARY KEY (id)
);

-- 2. task_feedback_template 테이블
...
(
    ...
    created_by             VARCHAR(255)          NULL,
    updated_by             VARCHAR(255)          NULL,
    task_feedback_emoji_id BIGINT                NOT NULL,
    is_active              VARCHAR(255)          NOT NULL,
    CONSTRAINT pk_task_feedback_template PRIMARY KEY (id)
);

-- 3. task_feedback_template_message 테이블
...
ALTER TABLE task_feedback_template
    ADD CONSTRAINT FK_TASK_FEEDBACK_TEMPLATE_ON_TASK_FEEDBACK_EMOJI FOREIGN KEY (task_feedback_emoji_id) REFERENCES task_feedback_emoji (id);
