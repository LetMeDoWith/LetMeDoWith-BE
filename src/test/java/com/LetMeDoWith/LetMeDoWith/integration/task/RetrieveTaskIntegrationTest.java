...
public class RetrieveTaskIntegrationTest extends AbstractIntegrationTest {
    ...
    void retrieveTasks1() throws Exception {
        ...
        result.andExpect(status().isOk())
              ...
              .andExpect(jsonPath("$.data.todoTasks[0].startTime").value(DateTimeUtil.toFormatString(
                  todoTask1.getStartTime())))
              ...
              .andExpect(jsonPath("$.data.todoTasks[1].startTime").value(DateTimeUtil.toFormatString(
                  todoTask2.getStartTime())))
              ...
              .andExpect(jsonPath("$.data.dowithTasks[0].status").value(dowithTask1.getStatus()
                                                                                   .name()))
              .andExpect(jsonPath("$.data.dowithTasks[0].date").value(dowithTask1.getDate()
                                                                                 .toString()))
              .andExpect(jsonPath("$.data.dowithTasks[0].startTime").value(DateTimeUtil.toFormatString(
                  dowithTask1.getStartTime())))
              ...
              .andExpect(jsonPath("$.data.dowithTasks[1].status").value(dowithTask2.getStatus()
                                                                                   .name()))
              .andExpect(jsonPath("$.data.dowithTasks[1].date").value(dowithTask2.getDate()
                                                                                 .toString()))
              .andExpect(jsonPath("$.data.dowithTasks[1].startTime").value(DateTimeUtil.toFormatString(
                  dowithTask2.getStartTime())));
    }
