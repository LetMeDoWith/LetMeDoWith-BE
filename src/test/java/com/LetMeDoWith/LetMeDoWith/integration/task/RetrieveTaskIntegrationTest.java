...
public class RetrieveTaskIntegrationTest extends AbstractIntegrationTest {
    ...
    void retrieveTasks1() throws Exception {
        ...
        result.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.data.todoTasks[0].isRoutine").value(false)) // TODO - 추후 Dowith Routine 추가 후 검증
                // 필요
                .andExpect(jsonPath("$.data.todoTasks[0].startTime")
                        .value(DateTimeUtil.toFormatString(todoTask1.getStartTime())))
                ...
                .andExpect(jsonPath("$.data.todoTasks[1].isRoutine").value(false)) // TODO - 추후 Dowith Routine 추가 후 검증
                // 필요
                ...
                .andExpect(jsonPath("$.data.dowithTasks[2].confirmedImageUrls")
                        .value(Matchers.is(
