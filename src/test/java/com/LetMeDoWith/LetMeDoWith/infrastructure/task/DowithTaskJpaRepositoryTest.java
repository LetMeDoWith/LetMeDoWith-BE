...
public class DowithTaskJpaRepositoryTest {
    ...
    void test_dowithTask_save() {
        // given
        DowithTask dowithTask1 = DowithTask.of(memberId,
                                               taskCategoryId1,
                                               title1,
                                               date1,
                                               startTime1);
    ...
    void test_dowithTask_routine_save() {
        // given
        List<DowithTask> dowithTasks1 = DowithTask.ofWithRoutine(memberId,
                                                                 taskCategoryId1,
                                                                 title1,
                                                                 date1,
                                                                 startTime1,
    ...
    void test_findDowithTaskAggregate() {
        // given
        DowithTask dowithTask = DowithTask.of(memberId,
                                              taskCategoryId1,
                                              title1,
                                              date1,
                                              startTime1);
