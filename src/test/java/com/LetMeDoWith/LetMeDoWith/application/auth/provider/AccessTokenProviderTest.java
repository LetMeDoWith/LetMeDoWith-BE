...
class AccessTokenProviderTest {
    ...
    public final String SAMPLE_MOD =
    ...
    void verifyExpiredTokenTest() {
        assertThrows(
                RestApiAuthException.class,
                () -> JwtUtil.parseTokenToJws(SAMPLE_TOKEN_EXPIRED, SAMPLE_RSA_PUBKEY),
    ...
    void verifyIllegalSignatureTokenTest() {
        assertThrows(
                RestApiAuthException.class,
                () -> JwtUtil.parseTokenToJws(SAMPLE_TOKEN_ILLEGAL_SIGNATURE, SAMPLE_RSA_PUBKEY),
                FailResponseStatus.INVALID_TOKEN.getMessage());
    }
    ...
    void verifyMalformedTokenTest() {
        assertThrows(
                RestApiAuthException.class,
                () -> JwtUtil.parseTokenToJws(SAMPLE_TOKEN_MALFORMED, SAMPLE_RSA_PUBKEY),
                FailResponseStatus.INVALID_TOKEN.getMessage());
    }
